...
@Component({
    selector: "transport-data-truck-detail-view",
    templateUrl: "./transport-data-truck-detail-view.component.html",
    styleUrls: ["../../styles/style-of-detail.component.scss"],
})
export class TransportDataTruckDetailViewComponent implements OnInit, OnDestroy {
